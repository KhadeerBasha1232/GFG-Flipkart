...
def get_code_from_database(problem_name):
    try:
...
def submit_problems(main_response, track_slug, cookies,delay):
    ...
    for problem in problems:
        ...
        if slug:
            ...
            code_info = get_code_from_database(problem_name)
...
def runner(url,session_id,delay):
    ...
    if cookies is not None:
        ...
        success,error = submit_problems(main_response, track_slug, cookies_dict, delay)
